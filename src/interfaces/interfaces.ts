...
export interface ClCache {
  ...
  match: (req: CacheRequest) => Promise<CacheResponse | undefined>;
  /**
   ...
   */
  put: (req: CacheRequest, res: CacheResponse) => Promise<any>;
}
...
export type ProductDetails = ProductDetailsShort | ProductDetailsLong;
